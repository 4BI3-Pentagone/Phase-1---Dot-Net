namespace Data.Migrations
{
    ...
    public partial class gg : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        state = c.Int(nullable: false),
                        course_CourseId = c.Int(),
                        visit_AppointmentId = c.Int(),
                    })
                .PrimaryKey(t => t.StepId)
                .ForeignKey("dbo.Courses", t => t.course_CourseId)
                .ForeignKey("dbo.Appointments", t => t.visit_AppointmentId)
                .Index(t => t.course_CourseId)
                .Index(t => t.visit_AppointmentId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Steps", "visit_AppointmentId", "dbo.Appointments");
            DropForeignKey("dbo.Steps", "course_CourseId", "dbo.Courses");
            ...
            DropIndex("dbo.Steps", new[] { "visit_AppointmentId" });
            DropIndex("dbo.Steps", new[] { "course_CourseId" });
